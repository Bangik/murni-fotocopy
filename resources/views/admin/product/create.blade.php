                        ...
                        <div class="card-body">
                            <form action="{{route('products.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('capitalPrice') is-invalid @enderror" name="capitalPrice" value="{{ old('capitalPrice') }}">
                                    @error('capitalPrice')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('minStock') is-invalid @enderror" name="minStock" value="{{ old('minStock') }}">
                                    @error('minStock')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
